// ===== BỘ CÂU HỎI LÝ THUYẾT LÁI XE =====
// Đây là file template với cấu trúc mẫu
// Bạn cần thêm 600 câu hỏi thực tế từ nguồn hợp pháp (sách giáo trình, ứng dụng có bản quyền)

const QUESTIONS = [
    // ===== PHẦN 1: KHÁI NIỆM VÀ QUY TẮC GIAO THÔNG (Câu 1-100) =====
    {
        id: 1,
        ...
        correct: 1,
        explanation: "Theo Luật Giao thông đường bộ, người điều khiển giao thông là cảnh sát giao thông hoặc người được giao nhiệm vụ điều khiển, hướng dẫn giao thông.",
        isCritical: false
    },
    {
        id: 2,
        ...
        correct: 2,
        explanation: "Đây là lỗi nghiêm trọng, vi phạm an toàn giao thông. Người lái xe vi phạm sẽ bị phạt tiền và tước GPLX từ 22-24 tháng.",
        isCritical: true
    },
    {
        id: 3,
        ...
        correct: 0,
        explanation: "Người lái xe phải mang đầy đủ 3 loại giấy tờ: GPLX, giấy đăng ký xe và giấy bảo hiểm trách nhiệm dân sự.",
        isCritical: false
    },

    // ===== PHẦN 2: BIỂN BÁO HIỆU ĐƯỜNG BỘ (Câu 101-250) =====
    {
        id: 101,
        ...
        correct: 0,
        explanation: "Biển báo nguy hiểm có hình tam giác đều, viền đỏ, nền vàng hoặc trắng để cảnh báo các tình huống nguy hiểm.",
        isCritical: false
    },
    {
        id: 102,
        ...
        answers: [
            "A. Cấm đỗ xe.",
            "B. Cấm dừng xe và đỗ xe.",
            "C. Hết cấm dừng xe và đỗ xe."
        ],
        correct: 1,
    ...
    // ===== PHẦN 3: SA HÌNH - TÌNH HUỐNG GIAO THÔNG (Câu 251-400) =====
    {
        id: 251,
    ...
    // ===== PHẦN 4: KỸ THUẬT LÁI XE (Câu 401-500) =====
    {
        id: 401,
        ...
        correct: 2,
        explanation: "Khi xuống dốc dài cần kết hợp phanh và phanh động cơ, tránh phanh liên tục gây quá nhiệt.",
        isCritical: false
    },

    // ===== PHẦN 5: CẤU TẠO VÀ SỬA CHỮA XE (Câu 501-560) =====
    {
        id: 501,
        category: "Cấu tạo và sửa chữa xe",
        question: "Công dụng của hệ thống treo trên ô tô là gì?",
        answers: [
            "A. Giảm ch진động từ mặt đường truyền lên thân xe.",
...

    {
        ...
        correct: 1,
        explanation: "Trong khu dân cư, tốc độ tối đa cho phép xe ô tô con là 50 km/h theo quy định của Luật Giao thông đường bộ.",
        isCritical: false
    },
    {
        id: 5,
        ...
        correct: 1,
        explanation: "Đèn vàng báo hiệu sắp chuyển sang đỏ. Người lái xe phải dừng trước vạch dừng, trừ khi đã vượt qua vạch dừng thì được đi tiếp.",
        isCritical: false
    },
    {
        id: 6,
        ...
        correct: 1,
        explanation: "Ở tốc độ 60 km/h, khoảng cách an toàn tối thiểu là 35 mét để đảm bảo đủ thời gian phản ứng và phanh xe.",
        isCritical: false
    },
    {
        id: 7,
        category: "Khái niệm và quy tắc giao thông",
        question: "Người điều khiển xe mô tô, xe gắn máy có nồng độ cồn trong máu vượt quá 50 miligam/100 mililít máu bị xử phạt như thế nào?",
        answers: [
            "A. Phạt cảnh cáo.",
        ...
        correct: 2,
        explanation: "Đây là vi phạm nghiêm trọng. Mức phạt cao nhất cho vi phạm nồng độ cồn vượt mức quy định là 6-8 triệu đồng và tước GPLX 22-24 tháng.",
        isCritical: true
    },
    {
        id: 8,
    ...
    },
    {
        ...
        correct: 3,
        explanation: "Tuyệt đối không được sử dụng điện thoại khi lái xe, kể cả tai nghe không dây. Đây là quy định bắt buộc để đảm bảo an toàn.",
        isCritical: false
    },
    {
        id: 10,
        ...
        correct: 1,
        explanation: "Trước khi vượt xe phải quan sát kỹ, bật xi nhan trái để báo hiệu, đảm bảo đủ khoảng cách an toàn và không có xe ngược chiều.",
        isCritical: false
    },
    ...
    // ===== PHẦN 2: BIỂN BÁO HIỆU ĐƯỜNG BỘ (Câu 101-250) =====
    {
        ...
        correct: 1,
        explanation: "Biển hình tròn nền xanh là biển hiệu lệnh, bắt buộc người tham gia giao thông phải thực hiện theo.",
        isCritical: false
    },
    {
        id: 104,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Biển hình tròn viền đỏ với số là biển cấm, quy định tốc độ tối đa không được vượt quá con số đó.",
        isCritical: false
    },
    ...
    // ===== PHẦN 3: SA HÌNH - TÌNH HUỐNG GIAO THÔNG (Câu 251-400) =====
    {
        ...
        correct: 1,
        explanation: "Khi nổ lốp, không phanh gấp vì dễ mất lái. Cần giữ vô lăng thẳng, từ từ nhả ga và đưa xe vào lề an toàn.",
        isCritical: false
    },
    {
        id: 253,
        ...
        correct: 1,
        explanation: "Trong điều kiện tầm nhìn kém, cần giảm tốc độ, bật đèn sương mù và tăng khoảng cách an toàn với xe phía trước.",
        isCritical: false
    },
    ...
    // ===== PHẦN 4: KỸ THUẬT LÁI XE (Câu 401-500) =====
    {
        ...
        correct: 1,
        explanation: "Trước khi lên dốc cần chuyển về số thấp để có đủ lực kéo. Không sang số khi đang leo dốc vì dễ mất đà.",
        isCritical: false
    },
    {
        id: 403,
        ...
        correct: 1,
        explanation: "Trên đường trơn, phanh nhẹ và nhịp nhàng giúp tránh khóa bánh xe, duy trì khả năng lái và giảm tốc hiệu quả.",
        isCritical: false
    },
    ...
    // ===== PHẦN 5: CẤU TẠO VÀ SỬA CHỮA XE (Câu 501-560) =====
    {
        ...
        correct: 1,
        explanation: "Đèn nhiệt độ đỏ báo hiệu động cơ quá nóng. Cần dừng xe ngay, tắt máy và để nguội trước khi kiểm tra. Không mở nắp két nước khi máy còn nóng.",
        isCritical: false
    },
    {
        id: 503,
        ...
        correct: 1,
        explanation: "Lốp thiếu áp suất làm tăng ma sát, tiêu hao nhiên liệu nhiều hơn, lốp mòn nhanh và giảm khả năng kiểm soát xe.",
        isCritical: false
    },

    // ===== PHẦN 6: ĐẠO ĐỨC NGƯỜI LÁI XE (Câu 561-600) =====
    {
        id: 561,
    ...
    },
    {
        ...
        correct: 1,
        explanation: "Người lái xe có trách nhiệm pháp lý và đạo đức phải dừng lại, sơ cứu nạn nhân, báo cơ quan chức năng và ở lại hiện trường.",
        isCritical: false
    }

    // ===== THÊM 580 CÂU HỎI CÒN LẠI =====
    // Bạn cần thêm các câu hỏi từ nguồn hợp pháp:
    // - Sách giáo trình lái xe có bản quyền
    // - Ứng dụng học lái xe đã mua
    // - Tài liệu từ trung tâm đào tạo lái xe
    ...
    //     isCritical: [true/false - câu điểm liệt],
...
const EXAM_CONFIG = {
    ...
    passingScore: 21,       // Điểm đạt (21/25)
